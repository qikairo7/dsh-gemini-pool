    ...
    function GeminiSettingsPage({ ctx }) {
      ...
      const refreshStatus = useCallback(async () => {
        try {
          ...
          if (value) {
            setCooldownForm({
              cooldownMs: value.cooldownMs ?? 60000,
              cooldownMaxMs: value.cooldownMaxMs ?? 3600000,
              disableThreshold: value.disableThreshold ?? 5,
              probeIntervalMs: value.probeIntervalMs ?? 300000,
            });
          }
          return value;
        } catch (err) {
            ...
            cooldownExpanded
              ? React.createElement(
                  ...
                  React.createElement(
                    ...
                    React.createElement("label", { className: "dsha-input-label" }, tr("cooldownMsLabel")),
                    React.createElement("input", {
                      type: "number",
                  ...
                  React.createElement(
                    "div",
                    { className: "dsha-input-group" },
                    React.createElement("label", { className: "dsha-input-label" }, tr("cooldownMaxMsLabel")),
                    React.createElement("input", {
                      type: "number",
                      className: "dsha-input",
                  ...
                  React.createElement(
                    "div",
                    { className: "dsha-input-group" },
                    React.createElement("label", { className: "dsha-input-label" }, tr("disableThresholdLabel")),
                    React.createElement("input", {
                      type: "number",
                      className: "dsha-input",
                  ...
                  React.createElement(
                    "div",
                    { className: "dsha-input-group" },
                    React.createElement("label", { className: "dsha-input-label" }, tr("probeIntervalMsLabel")),
                    React.createElement("input", {
                      type: "number",
                      className: "dsha-input",
                  ...
                  React.createElement(
                    ...
                    cooldownMsg
                      ? React.createElement("span", { style: { fontSize: "12px", color: "var(--dsha-green-text)" } }, cooldownMsg)
                      : null,
                  ),
                )
              : null,
