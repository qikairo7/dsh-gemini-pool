window.__ModuleLoader__.load({
  ...
  factory(require) {
    ...
    const STYLE_ID = "antigravity-pool-settings-style";
    const API = "/antigravity/api";
    const NS = "antigravity-pool";
...
`;
      ...
      return React.createElement(
        ...
        groups.map((group, gIdx) => {
          ...
          return React.createElement(
            ...
            React.createElement("div", { className: "dsha-group-title" }, group.title),
            (group.buckets || []).map((bucket, bIdx) => {
              ...
              const label = bucket.displayName || bucket.label || bucket.id || "Limit";

              return React.createElement(
                "div",
                { key: `b_${bIdx}`, className: bIdx > 0 ? "dsha-quota-item dsha-quota-item-spaced" : "dsha-quota-item" },
                React.createElement(
                  "div",
    ...
    function AntigravitySettingsPage({ ctx }) {
      ...
      return React.createElement(
        ...
        // Error banner
        error ? React.createElement("div", { className: "dsha-error" }, error) : null,
        ...
        React.createElement(
          ...
          accounts.length === 0
            ...
            : accounts.map((account) => {
                ...
                const cooldownSec = Math.max(1, Math.round((account.cooldownRemainingMs || 0) / 1000));

                return React.createElement(
                  "div",
                  {
                    key: account.id,
                    className: `dsha-account-card ${isPrimary ? "dsha-primary" : ""} ${isCooling ? "dsha-cooldown" : ""}`,
                  },
                  // Sub-card Head: Email + Badges/Tags + Online/Cooldown Status
                  React.createElement(
                    "div",
                    ...
                    React.createElement(
                      ...
                      isManualSelected && poolStatus.schedulingMode === "manual"
                        ? React.createElement("span", { className: "dsha-tag dsha-tag-current" }, "CURRENT")
                        : null,
                    ),
                    React.createElement(
                      "div",
                      { className: `dsha-acc-status ${isCooling ? "dsha-status-cooldown" : "dsha-status-online"}` },
                      React.createElement("span", { className: `dsha-status-dot ${isCooling ? "dsha-dot-cooldown" : "dsha-dot-online"}` }),
                      isCooling
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement("label", { className: "dsha-input-label" }, tr("imageModelLabel")),
              React.createElement(
                "select",
                {
            ...
            React.createElement(
              "div",
              { className: "dsha-input-group" },
              React.createElement("label", { className: "dsha-input-label" }, tr("imageOutputDirLabel")),
              React.createElement("input", {
                type: "text",
                className: "dsha-input",
